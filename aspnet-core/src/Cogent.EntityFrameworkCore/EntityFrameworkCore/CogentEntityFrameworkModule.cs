...
using Cogent.EntityFrameworkCore.Seed;
...
namespace Cogent.EntityFrameworkCore
{
    ...
    public class CogentEntityFrameworkModule : AbpModule
    {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(CogentEntityFrameworkModule).GetAssembly());
        }
